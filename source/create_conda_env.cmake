...
function(create_conda_env retvar env_name output_path requirements_file)
    ...
    if (EXISTS ${CONDA_ENV_PATH})
        ...
        find_program(TMP_PYBIN "python" PATHS "${CONDA_ENV_PATH}/bin" NO_DEFAULT_PATH)
        if (NOT TMP_PYBIN)
    ...
    find_program(CONDA_EXE "conda" PATHS "/opt/conda/bin")
    if (NOT CONDA_EXE)
        message(FATAL_ERROR "Unable to find conda executable. Please check your PATH")
    endif()
    set(ENV_ARGS "create" "-y" "-q" "--copy" "-p" "${CONDA_ENV_PATH}" "python=3.7.3")
