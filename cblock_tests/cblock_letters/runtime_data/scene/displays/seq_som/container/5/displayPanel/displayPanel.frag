...
#define PATTERN
    ...
    texture_coordinate_pattern[0]=25.0*texture_coordinate[0]-floor(25.0*texture_coordinate[0]);
    texture_coordinate_pattern[1]=25.0*texture_coordinate[1]-floor(25.0*texture_coordinate[1]);
