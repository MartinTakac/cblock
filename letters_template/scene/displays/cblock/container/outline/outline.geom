...
{	
	...
	vec3 start_vertex=vec3(-1.067*scalex+offsetx,1.395*scaley+offsety,0.0);
	vec3 A=vec3(1.067*scalex+offsetx,1.395*scaley+offsety,0.0);
    vec3 B=vec3(1.067*scalex+offsetx,-1.395*scaley+offsety,0.0);
    vec3 C=vec3(-1.067*scalex+offsetx,-1.395*scaley+offsety,0.0);
    vec3 end_vertex=vec3(-1.067*scalex+offsetx,1.395*scaley+offsety,0.0);
