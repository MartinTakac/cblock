...
#define PATTERN
    ...
    texture_coordinate_pattern[0]=1.0*texture_coordinate[0]-floor(1.0*texture_coordinate[0]);
    texture_coordinate_pattern[1]=1.0*texture_coordinate[1]-floor(1.0*texture_coordinate[1]);
