...
{	
	...
	vec3 start_vertex=vec3(-0.313*scalex+offsetx,0.576*scaley+offsety,0.0);
	vec3 A=vec3(0.313*scalex+offsetx,0.576*scaley+offsety,0.0);
    vec3 B=vec3(0.313*scalex+offsetx,-0.576*scaley+offsety,0.0);
    vec3 C=vec3(-0.313*scalex+offsetx,-0.576*scaley+offsety,0.0);
    vec3 end_vertex=vec3(-0.313*scalex+offsetx,0.576*scaley+offsety,0.0);
